...
const generateUploadSignature = async (req, res) => {
  try {
    ...
    res.json({
      signature, //we need to send timestamp and public id because to verify cloudinary
      timestamp, //will create hash of timestamp and public id as those were in signature
      public_id: publicId, //and verify with the sent signature
      api_key: process.env.CLOUDINARY_API_KEY,
