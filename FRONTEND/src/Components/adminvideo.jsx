  ...
  return (
    <div className={`min-h-screen flex flex-col pt-10 ${darkMode ? 'bg-[#121212] text-white' : 'bg-white text-black'} p-4 relative`}>
      ...
      <div className="container mx-auto ">
        <h1 className="text-3xl font-bold mb-4">Video Upload & Delete</h1>
        {fetchLoading ? (
          ...
          <table className="table w-full max-w-4xl mx-auto">
            <thead>
              <tr>
                ...
                <th className="w-3/12 text-gray-400 text-center">Actions</th>
              </tr>
            </thead>
            <tbody>
              {problems.map((problem, index) => (
                ...
                >
                  ...
                  <td>
                    <span className="badge badge-primary ">{problem.tags.toUpperCase()}</span>
                  </td>
